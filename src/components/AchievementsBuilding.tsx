// src/components/AchievementsBuilding.tsx
...
type AchievementsBuildingProps = {
...
const AchievementsBuilding: React.FC<AchievementsBuildingProps> = ({
  position,
  scale = [1, 1, 1],
  rotation = [0, 0, 0],
  onClick,
