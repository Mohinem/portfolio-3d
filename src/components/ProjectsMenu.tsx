...
import RealEstateExchangeImage from "/Projects/RealEstateExchange.png";
import WordleReinforcementLearningEnvironmentImage from "/Projects/WordleReinforcementLearningEnvironment.jpeg";
...
const projects: Project[] = [
  ...
  {
    name: "Real Estate Exchange",
    imageUrl: RealEstateExchangeImage,
    description: "A platform to swap real estate holdings seamlessly, without third party intervention. To bring this project to life, I used NodeJS for backend, React for frontend, and PostgreSQL.",
    githubUrl: "https://real-estate-exchange.vercel.app/",
  },
  {
  ...
  {
    name: "Wordle Reinforcement Learning Environment",
    imageUrl: WordleReinforcementLearningEnvironmentImage,
    description:
      "An environment for training Reinforcement Learning (RL) agents for the Wordle game, using the Gymnasium environment. Also created an elimination based agent to deliver 93% success rate on a dataset of 500 words.",
    githubUrl: "https://github.com/Mohinem/wordle-gym-environment",
  },    
  {
    name: "SoundCloud",
    imageUrl: Soundcloud,
  ...
  },    
  {
    ...
    imageUrl: SoraImage,
    description:
      "Six of my favourite videos generated by me on Sora.",
